...
def generar_predicciones(url, match, modelo):
    """
...
# fijarse que el link tiene que estan en ingles "en"
url = "https://fbref.com/en/partidos/f8172af5/Boca-Juniors-Argentinos-Juniors-Octubre-6-2024-Liga-Profesional-Argentina"
match = "Boke - Argentinos" #TODO: claramente no importa lo que pongas aca, pasa que copié la funcion de la notebook de generacion de data

# Generar las predicciones
predicciones_df = generar_predicciones(url, match, modelo)
